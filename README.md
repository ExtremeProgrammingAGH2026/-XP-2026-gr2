...
```
cd existing_repo
git remote add origin https://gitlab.kis.agh.edu.pl/io/xp-2026-gr2.git
git branch -M main
...
* [Set up project integrations](https://gitlab.kis.agh.edu.pl/io/xp-2026-gr2/-/settings/integrations)
